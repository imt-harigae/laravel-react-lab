        ...
        <main className="bg-gray-50 text-gray-800 dark:bg-neutral-900 dark:text-white">
            ...
            <section className="flex flex-col items-center justify-center text-center py-20 px-4">
                ...
                <div className="flex gap-4">
                    <Link to="/todos" className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                        Todoを開く
                    </Link>
                    <Link to="/books" className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                        Bookを開く
                    </Link>
                    <Link to="/tailwind" className="px-6 py-3 border border-gray-400 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700">
                        Tailwindの動作確認
                    </Link>
                </div>
            </section>
            ...
            {/* Feature Section */}
            <section className="bg-white dark:bg-neutral-900 py-10 px-4">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-lg text-gray-600 dark:text-neutral-300 mb-8">
                        このサイトではTodoや本の管理、Tailwindの確認ができます。
                    </p>
            ...
            <section className="bg-white dark:bg-neutral-900 py-20 px-4">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-lg text-gray-600 dark:text-neutral-300 mb-8">
                        このサイトは現在も開発中です。以下のような機能を順次追加予定です。
                    </p>
